...
def train(model, train_loader, val_loader, optimizer, loss_function, device, num_epochs, save_path):#, scheduler):
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch+1) % num_val_epochs ==0:
            ...
            print("*"*10)
            print(f'Epoch {epoch} evaluation completed, the average OA is {sum(OA_list)/len(OA_list)}, the val loss is {val_loss_avg}') #added new
            print("*"*10)
...
if __name__ == "__main__":
    ...
    num_epochs = 200
    save_path = "E://VS Projects//test_25-2-2025_FC//checkpoint9-withMatch2"
